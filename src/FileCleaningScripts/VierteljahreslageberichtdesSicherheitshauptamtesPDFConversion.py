...
# Summary: Converts all files from Vierteljahreslagebericht des Sicherheitshauptamtes
...
path = "/Users/cgoodwin/Desktop/Vierteljahreslagebericht des Sicherheitshauptamtes/*.html"
