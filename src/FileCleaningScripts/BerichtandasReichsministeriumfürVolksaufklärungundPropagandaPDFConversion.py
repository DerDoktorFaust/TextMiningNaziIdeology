...
# Summary: Converts all files from Bericht an das Reichsministerium für Volksaufklärung und Propaganda
...
path = "/Users/cgoodwin/Desktop/Bericht an das Reichsministerium für Volksaufklärung und Propaganda/*.html"
