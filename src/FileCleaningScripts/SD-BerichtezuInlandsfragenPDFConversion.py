...
# Summary: Converts all SD-Berichte zu Inlandsfragen
...
# proper names of the format YYYY.MM.DD Part # - SD-Berichte zu Inlandsfragen.html
# which was run with the script SD-BerichtezuInlandsfragenFileRenaming.py
#
...
path = "/Users/cgoodwin/Desktop/SD-Berichte zu Inlandsfragen/*.html"
