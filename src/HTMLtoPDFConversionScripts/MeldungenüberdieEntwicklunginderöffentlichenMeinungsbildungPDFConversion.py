...
# Summary: Converts all files from Meldungen über die Entwicklung in der öffentlichen Meinungsbildung
...
path = "/Users/cgoodwin/Desktop/Meldungen über die Entwicklung in der öffentlichen Meinungsbildung/*.html"
