...
# Summary: Converts all files from Bericht aus Akten der Geschäftsführenden Reichsregierung Dönitz
...
path = "/Users/cgoodwin/Desktop/Bericht aus Akten der Geschäftsführenden Reichsregierung Dönitz/*.html"
