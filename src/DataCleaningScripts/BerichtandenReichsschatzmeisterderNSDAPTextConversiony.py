...
# Summary: Converts all files from Bericht an den Reichsschatzmeister der NSDAP from HTML to TXT
#
...
path = "/Users/cgoodwin/Desktop/Bericht an den Reichsschatzmeister der NSDAP HTML/*.html"
