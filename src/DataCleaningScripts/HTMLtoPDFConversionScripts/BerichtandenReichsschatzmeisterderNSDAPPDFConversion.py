...
# Summary: Converts all files from Bericht an den Reichsschatzmeister der NSDAP
...
path = "/Users/cgoodwin/Desktop/Berichte an den Reichsschatzmeister der NSDAP/*.html"
